...
def main():
    ...
    assistant_apikey = 'wDlG3iKSkWxt430_Sw1o4RxXeOfl4428-s0Sy7f91eOQ'
    assistant_url = 'https://api.eu-gb.assistant.watson.cloud.ibm.com'
    assistant_id = '9812613f-d272-446a-aa32-3d8e8aa9211f'
    ...
    tts_url = 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/60de07c8-f6d6-40a1-b092-8ad817b7883e'
    tts_apikey = 'r_Nj9PqdN-hvPPjvVfsKo9fldCgTll1UbPCXC99Nr0la'
    ...
    # 6 seconds in the dedicated thread).
        ws.run_forever()
        filename = 'output'+ str(count) + '.txt'
        filepath = 'text files\\'+ filename
        savetxt(transcript, filepath)
        ...
        filename2 = 'speech'+ str(count) + '.mp3'
        filepath2 = 'recordings\\'+ filename2
        with open(filepath2, 'wb') as audio_file:
            res = tts.synthesize(response2, accept="audio/mp3", voice="en-US_HenryV3Voice").get_result()
            audio_file.write(res.content)
        playsound(filepath2)
        count+=1
        if response2 == "You're welcome, you're being redirected to the payment page." or response2 == "Fine, you're being redirected to the payment page.":
            done = True
